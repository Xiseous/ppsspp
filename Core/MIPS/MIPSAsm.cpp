...
public:
  ...
  bool write(void *data, size_t length) override {
    ...
    // In case this is a delay slot or combined instruction, clear cache above
    // it too.
  ...
  bool seekPhysical(int64_t physicalAddress) override {
    return seekVirtual(physicalAddress);
  }
